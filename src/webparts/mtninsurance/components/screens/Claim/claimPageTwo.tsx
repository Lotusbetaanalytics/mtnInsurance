...
const ClaimPageTwo = () => {
  ...
  const [finalAdjustedLiabilityAmount, setFinalAdjustedLiabilityAmount] =
    useState("");
  const [amountReceived, setAmountReceived] = useState("");
  const [amountOutstanding, setAmountOutstanding] = useState("");
  const [status, setStatus] = useState("");
  const [dateOfSettlemetOfferReceipt, setDateOfSettlemetOfferReceipt] =
    useState("");
    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        ...
        <div className={styles.btnContainer}>
          <PrevBtn handler={cancelHandler} buttonName="Previous" />{" "}
